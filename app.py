...
if page == "Home":
    ...
    **WebSage** is a cutting-edge RAG Chatbot application that allows you to extract content from any URL, generate detailed summaries, and interact with the content using advanced language models.  
    With options to choose between **(Gemma2-9b-It)**  and **(deepseek-r1-distill-llama-70b)** engines for both summarization and conversation, WebSage gives you the flexibility to explore and deploy the best AI solutions for your needs.
    ...
    **Features:**
    ...
    """
                    ...
                    summarizer = ChatGroq(model_name = 'Gemma2-9b-It', groq_api_key= groq_api_key, temperature=0.3, max_tokens=1500)
        ...
        with col3:
            ...
            if st.session_state.embedding_done:
                ...
                llm_choice = st.radio("Select LLM Type", ("Gemma2-9b-It", "deepseek-r1-distill-llama-70b"), index=0, key="llm_choice")
    ...
    """
                ...
                if llm_choice == "Closed Source":
                    llm = ChatGroq(model_name = 'Gemma2-9b-It', groq_api_key= groq_api_key, temperature=0.3, max_tokens=1000)
                else:
                    # llm = ChatGroq(model="deepseek-r1:1.5b", base_url="http://localhost:11434", temperature=0.3)
                    llm = ChatGroq(model_name = 'deepseek-r1-distill-llama-70b', groq_api_key= groq_api_key, temperature=0.3, max_tokens=1000)
